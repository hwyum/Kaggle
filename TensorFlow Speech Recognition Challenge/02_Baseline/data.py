...
class SpeechDataset(Dataset):
    def __init__(self, mode, label_to_int, wav_list, label_list=None):
        ...
        # 배경 소음 데이터를 미리 읽어온다
        self.background_noises = [librosa.load(x, sr=self.sr)[0] for x in glob("~/Documents/Data Science_Reference/Kaggle/TensorFlow Speech Recognition Challenge/data/train/audio/_background_noise_/*.wav")]
